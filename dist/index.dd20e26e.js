    ...
    RGraph.SVG.Horseshoe = function(conf) {
        ...
        this.draw = function() {
            ...
            if (properties.adjustable && !this.adjusting_event_listeners_installed) {
                ...
                var obj = this;
                var func = function(e) {
                    var div = e.currentTarget, mouseX = e.offsetX, mouseY = e.offsetY;
                    if (RGraph.SVG.ISFF) {
        ...
        this.drawMeter = function() {
            ...
            if (typeof properties.width === "string") width += Number(properties.width);
            // First thing to do is clear the canvas to the backgroundColor
            if (properties.backgroundColor) var rect = RGraph.SVG.create({
                svg: this.svg,
                type: "rect",
        ...
        this.drawLabels = function() {
            ...
            if (properties.labelsCenter) {
                ...
                if (properties.labelsCenterSpecific) properties.labelsCenterSpecific = RGraph.SVG.labelSubstitution({
                    object: this,
        ...
        this.getValue = function(e) {
            ...
            if (typeof e === "number") var angle = e;
            else // Get the angle of the click
        ...
        this.grow = function() {
            ...
            var opt = arguments[0] || {}, frames = opt.frames || 60, frame = 0, diff = this.value - this.currentValue, step = diff / frames, callback = arguments[1] || function() {}, initial = this.currentValue;
            function iterator() {
        ...
        this.clipToScaleWorker = function(clipPath) {
            ...
            RGraph.SVG.create({
                ...
                type: "path",
                attr: {
                    d: "M {1} {2} {3} z".format(this.centerx, this.centery, path)
                }
            });
...
//# sourceMappingURL=index.dd20e26e.js.map
